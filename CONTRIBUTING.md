...
````
    ...
    to the ritoon/hapiclient-go repository. This is a problem because the contributor
...
* Submit a pull request to the repository in the ritoon/hapiclient-go repo.
* Include a link to the pull request in the github ticket.
